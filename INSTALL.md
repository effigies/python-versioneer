...
* `style`: the style of version string to be produced. See
  [Styles](README.md#styles) for details. Defaults to "pep440", which looks
  like `TAG[+DISTANCE.gSHORTHASH[.dirty]]`.
